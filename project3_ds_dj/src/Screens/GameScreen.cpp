	...
	: Screen(GameState::GamePlay), isPaused(false)
{
	...
	m_resume = new Button(m_resumeTexture, sf::Vector2f(1920.0f / 2.0f, (1080.0f / 2.0f) - 80.0f), focusIn, focusOut, 1.0f, 1.0f, sf::Vector2f());
	m_mainMenu = new Button(m_mainMenuTexture, sf::Vector2f(1920.0f / 2.0f, (1080.0f / 2.0f) + 80.0f), focusIn, focusOut, 1.0f, 1.0f, sf::Vector2f());
