...
public:
	GameScreen(XboxController &controller, sf::View &view, sf::Sound *confirmSound, 
		sf::Sound *shotSound, sf::Sound *waveCompleteSound, sf::Sound *shieldSound, sf::Sound *doubleBulletSound, 
		sf::Sound *heartSound, sf::Sound *deathSound, sf::Sound *turretShotSound, sf::Sound *hitWallSound, sf::Sound *navigateSound);
